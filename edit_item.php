...
?>
          <div class="row"></div>
<form action="item_edited.php" method="post" enctype="multipart/form-data" name="form1" id="form"  onSubmit="return validation();">
<input type="hidden" name="ID" id="idd" value="<?php echo $row['ID']; ?>" class="form-control"/>
<div class="col-lg-12">
<div class="form-group">
<label for="fname">Names</label>
<input type="text" name="name" value="<?php echo $row['name'];?>" placeholder="Enter Item Name" class="form-control">
</div>
...
<input type="text" name="size" value="<?php echo $row['size'];?>" placeholder="Enter Item Size" class="form-control">
</div>

<div class="form-group">
<label for="fname">Year</label>
<input type="text" name="year" value="<?php echo $row['year'];?>" placeholder="Enter Item Year" class="form-control">
</div>

<div class="form-group">
<label for="fname">Chamber</label>
<input type="text" name="chamber" value="<?php echo $row['chamber'];?>" placeholder="Enter Item Chamber" class="form-control">
</div>

<div class="form-group">
<label>Description*</label>
<textarea class="form-control" id="comment" name="decs" placeholder="Enter Item Description"><?php echo $row['decs'];?></textarea>
</div>
